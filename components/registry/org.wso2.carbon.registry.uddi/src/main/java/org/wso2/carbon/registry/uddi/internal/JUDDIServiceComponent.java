...
public class JUDDIServiceComponent {
    ...
    private void copyWebAppIfNotExist() throws IOException {
        ...
        String tempWebAppDir = CarbonUtils.getCarbonHome() + File.separator + "repository" + File.separator +
                "resources" + File.separator + TEMP_WEBAPP_DIR;
        String webAppDir = CarbonUtils.getCarbonHome() + File.separator + "repository" + File.separator +
