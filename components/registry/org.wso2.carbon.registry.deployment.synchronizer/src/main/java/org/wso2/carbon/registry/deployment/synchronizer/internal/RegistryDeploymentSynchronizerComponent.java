...
public class RegistryDeploymentSynchronizerComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        registryDepSynServiceRegistration = context.getBundleContext().registerService(ArtifactRepository.class
                .getName(), registryBasedArtifactRepository, null);
    }
    ...
    protected void unsetConfigurationContextService(ConfigurationContextService service) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("carbon-registry deployment synchronizer component unbound from the configuration context " +
                    "service");
        }
